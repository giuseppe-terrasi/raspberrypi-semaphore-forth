...
: C, JF-HERE @ C! 1 JF-HERE +! ;
: S" IMMEDIATE ( -- addr len )
	STATE @ IF
		' LITS , JF-HERE @ 0 ,
		BEGIN KEY DUP '"'
                <> WHILE C, REPEAT
		DROP DUP JF-HERE @ SWAP - 4- SWAP ! ALIGN
	ELSE
		JF-HERE @
		BEGIN KEY DUP '"'
                <> WHILE OVER C! 1+ REPEAT
		DROP JF-HERE @ - JF-HERE @ SWAP
	THEN
;
: ." IMMEDIATE ( -- )
	STATE @ IF
...
: FORGET DICT DUP @ LATEST ! JF-HERE ! ;
...
: SEE
	...
	';' EMIT CR 2DROP
;
: :NONAME 0 0 CREATE JF-HERE @ DOCOL , ] ;
: ['] IMMEDIATE ' LIT , ;
